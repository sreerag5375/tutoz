      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-4xl font-semibold mb-4">
            <span style={{ color: "#004077" }}>{downloadSection.title.first}</span>
            <span className="text-primary">{downloadSection.title.highlight}</span>
            <span style={{ color: "#004077" }}>{downloadSection.title.last}</span>
          </h2>
          ...
          <div className="order-2 lg:order-2 space-y-8">
            <div>
              <h3
                ...
                style={{ color: "#004077" }}
              >
                {downloadSection.content.heading}
              </h3>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                {downloadSection.content.description}
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-base">{downloadSection.buttons.appStore}</span>
              </Button>
              <br />
              {/* Play Store Button */}
              <Button
              ...
              >
                ...
                <span className="text-base">{downloadSection.buttons.playStore}</span>
              </Button>
              <br />
            </div>
          </div>
